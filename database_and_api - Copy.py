...
def update_quantity(item_id):
    ...
    update_quantity = db.execute('update carts set quantity= \'{}\' where item_id=\'{}\' and user_id=\'{}\''.format(desired_quantity,item_identity,user_identity))
...
def formatted_result(row):
    return "product id: " + str(row.item_id) + " " + "product name: " + str(row.name)+ " "+"price :"+ str(row.description)
